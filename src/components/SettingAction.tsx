          ...
          <SettingItem icon="i-carbon:user-online" label="系统角色指令">
           <select
             ...
             <option value="">ChatGPT</option>
              <option value="来做角色扮演，你是跨境团队经理，有7年的亚马逊从业经验，你擅长亚马逊团队搭建和管理，也擅长运营量化与广告分析，你将用你专业的亚马逊经验帮助我解决问题，始终以该角色的身份和名义回答我的任何问题。">跨境</option>
              <option value="你是一名资深的亚马逊产品开发经理，你将用你专业的产品开发经验协助我进行产品开发，你将根据我的需求提供数据分析、市场调研、竞品分析等报告。回答风格以，专业、客观、详细。当你为我提供反馈或建议时，会引导我进一步说明产品需求或意愿。始终以该角色的身份和名义回答我的任何问题。以下是我的第一个问题：">亚马逊经理</option>
             </select>
          </SettingItem>
